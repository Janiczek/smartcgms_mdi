namespace mdi_simulator
{
    internal class Simulation
    {
        ...
        public static List<OutputRow> Simulate(Input input)
        {
        ...
        static void WriteOutputToCsv(List<OutputRow> output)
        {
            ...
            foreach (var row in output) writer.WriteLine(row.ToString());
        }
